import { initializeApp } from 'firebase/app';
        ...
        import { getMessaging, getToken as getMessagingToken } from 'firebase/messaging'; // Переименовываем для ясности
        ...
        // Экспортируем getToken как глобальную функцию
        window.apbGetToken = getMessagingToken;
        window.apb.getToken = getMessagingToken; // Или положить внутрь объекта

        // --- КОНЕЦ ФАЙЛА firebase-init.js ---
