...
export function Settings({ show, onClose, adminDeviceId }) {
  ...
  return React.createElement(
    ...
    React.createElement(
      'div',
      {
        className: 'bg-white w-full max-w-2xl rounded-[32px] p-8 shadow-2xl space-y-6 border border-gray-100 max-h-[90vh] overflow-y-auto',
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement('th', { className: 'px-4 py-2 text-left font-medium text-gray-500' }, 'Привязка'),
                React.createElement('th', { className: 'px-4 py-2 text-left font-medium text-gray-500' }, 'Действие')
              )
            ),
            React.createElement(
              'tbody',
              ...
              loadingJudges
                ? React.createElement(
                    'tr',
                    null,
                    React.createElement('td', { colSpan: 5, className: 'px-4 py-4 text-center text-gray-400' }, 'Загрузка...')
                  )
                : judges.length === 0
                ? React.createElement(
                    'tr',
                    null,
                    React.createElement('td', { colSpan: 5, className: 'px-4 py-4 text-center text-gray-400' }, 'Нет ключей')
                  )
                : judges.map((judge) =>
                    React.createElement(
                      'tr',
                      ...
                      React.createElement('td', { className: 'px-4 py-3' }, judge.deviceId ? judge.deviceId.substring(0, 8) + '…' : '—'),
                      React.createElement(
                        'td',
                        { className: 'px-4 py-3' },
                        React.createElement(
